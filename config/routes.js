...
const uploadMiddleware = require('./cloudinary.config')

//cities
router.get('/cities', authMiddleware.isAuthenticated, userMiddleware.isTourist, citiesController.list)
router.post('/cities/new', authMiddleware.isNotAuthenticated, uploadMiddleware.uploadCloudCity('photo'), citiesController.create)
...
//places
router.post('/places/new', authMiddleware.isAuthenticated, userMiddleware.isCity, uploadMiddleware.uploadCloudPlace('photo'), placesController.create)
